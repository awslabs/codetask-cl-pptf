...
def get_lang_tokens():
    lang_tokens = ['<en>', '<java>', '<c_sharp>', '<python>', '<ruby>','<javascript>','<php>', '<go>', '<none>']
    return lang_tokens

def get_task_tokens():
    task_tokens = ['<translate>', '<summarize>', '<refine>', '<concode>', '<defect>', '<clone>']
    return task_tokens
...
def build_or_load_gen_model(args):
    ...
    special_tokens = get_task_tokens() + get_lang_tokens()
