...
# python run_exp.py --model_tag codet5_small --task summarize --sub_task python --gpu=0
# python run_exp.py --model_tag codet5_small --task concode --sub_task none --gpu=1
# python run_exp.py --model_tag codet5_small --task translate --sub_task java-cs --gpu=2
# python run_exp.py --model_tag codet5_small --task refine --sub_task small --gpu=3
# python run_exp.py --model_tag codet5_small --task defect --sub_task none --gpu=4
# python run_exp.py --model_tag codet5_small --task clone --sub_task none --gpu=5
# python run_exp.py --model_tag codet5_small --task multi_task --sub_task none --gpu=6